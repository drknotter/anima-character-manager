...
var ABILITY_DATA = {
  ...
  'kiAccumulation_str':{'type':'primary','baseCharacteristic':'str','name':'Ki Accumulation Multiple (Str)','description':'No description yet!'},
  'kiAccumulation_agi':{'type':'primary','baseCharacteristic':'agi','name':'Ki Accumulation Multiple (Agi)','description':'No description yet!'},
  'kiAccumulation_dex':{'type':'primary','baseCharacteristic':'dex','name':'Ki Accumulation Multiple (Dex)','description':'No description yet!'},
  'kiAccumulation_con':{'type':'primary','baseCharacteristic':'con','name':'Ki Accumulation Multiple (Con)','description':'No description yet!'},
  'kiAccumulation_pow':{'type':'primary','baseCharacteristic':'pow','name':'Ki Accumulation Multiple (Pow)','description':'No description yet!'},
  'kiAccumulation_wp':{'type':'primary','baseCharacteristic':'wp','name':'Ki Accumulation Multiple (WP)','description':'No description yet!'},
