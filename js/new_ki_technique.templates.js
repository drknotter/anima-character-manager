...
{{#data.bonus.levels}}
<tr class="effectLevel"><td class="radio"><input type="radio" name="{{key}}"></td><td>{{amount}}</td><td>{{#isPrimary}}{{primary}}{{/isPrimary}}{{^isPrimary}}{{secondary}}{{/isPrimary}}</td><td>{{martialKnowledge}}</td><td>{{maintainCost}}</td><td>{{minimumTechniqueLevel}}</td></tr>
{{/data.bonus.levels}}
</table>
